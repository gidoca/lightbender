...
use crate::buffer::{begin_one_shot, end_one_shot, find_memory_type, GpuBuffer};
...
impl GpuImage {
    ...
    pub unsafe fn upload_rgba8(
        ...
        Self::upload_image(
            ...
            width, height, pixels, vk::Format::R8G8B8A8_SRGB,
        )
    }
    ...
    pub unsafe fn upload_rgba32f(
        ...
        Self::upload_image(
            device, instance, physical_device, command_pool, queue,
            width, height, byte_data, vk::Format::R32G32B32A32_SFLOAT,
        )
    }
    ...
    unsafe fn upload_image(
        ...
        let size = pixel_bytes.len() as vk::DeviceSize;
        ...
        unsafe { staging.upload_slice(device, pixel_bytes)?; }
